<template>
    <div class="category-admin mt-3 ml-3">
        <b-form>
...
export default {
    ...
    methods: {
        ...
        save() {
            ...
            const categoria = {id: this.category.id, name: this.category.name, parentId: this.category.parentId}
            axios[method](`${baseUrl}/categories${id}`, categoria)
                .then(() => {
